...
The SunPy public API will be defined as *any object that is present in the
`__all__` list in the Python source*, and any attributes on those objects not
prefixed with one or more underscores, and are therefore included in the API
documentation.
