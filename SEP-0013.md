...
.. _Astropy APE-20: <https://github.com/astropy/astropy-APEs/blob/main/APE20.rst>
...
This SEP proposes that the `sunpy core package <https://github.com/sunpy/sunpy>`*and all packages under the SunPy organization adopt |Black|* for formatting code.
...
Code formatting is controversial and the `astropy-dev thread`_about *Black*
...
initially, one of the co-authors of this APE, and highlighted in detail in `this
blog post
