...
* If there are the same number of candidates as seats then the vote will be held with a "Reopen Nominations" option. If this option gains the most votes then a two week nomination period will reopen, and the election will be held after this period ends.
