...
When adding a new project custodian, the existing custodians are expected to make their descisions based on if they meet the criteria laid out above, we want the custodians to be as inclusive of the SunPy Community as possible.
