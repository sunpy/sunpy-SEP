...
For a detailed introduction to the whole `ndcube` package please see the `ndcube documentation <https://docs.sunpy.org/projects/ndcube/en/v2.0.0b2/introduction.html>`__, a high level familiarity with the package is assumed in the rest of this SEP.
